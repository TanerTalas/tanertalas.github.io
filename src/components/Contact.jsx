        ...
        <Reveal>
          <div className="grid grid-cols-1 items-center gap-8 rounded-3xl bg-navy p-8 transition-[background] duration-1000 md:grid-cols-[1.2fr_1fr] md:p-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                href={`mailto:${EMAIL}`}
                className="inline-flex w-max items-center gap-3 rounded-full bg-[#F2F5FA] px-7 py-3.5 font-display text-[1.1rem] font-semibold text-[#0B1D33] transition-[transform,box-shadow] duration-300 hover:-translate-y-[3px] hover:shadow-[0_10px_24px_rgba(0,0,0,0.4)]"
              >
