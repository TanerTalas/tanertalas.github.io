  ...
  const I18N = {
    EN: {
      meta: {
        ...
        description:
          "This is the projects page of Taner Talas's portfolio website, showcasing his user interface-focused projects and front-end development work.",
      },
      nav: {
        menu: {
          homepage: "Homepage",
    ...
    TR: {
      meta: {
        ...
        description:
          "Bu, Taner Talas'ın kullanıcı arayüzü odaklı projelerini ve front end geliştirme çalışmalarını sergileyen portföy web sitesinin projeler sayfasıdır.",
      },
      nav: {
        menu: {
          homepage: "Ana Sayfa",
