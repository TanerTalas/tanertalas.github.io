(() => {
  const I18N = {
    EN: {
      meta: {
        ...
        description:
          "This is the homepage of Taner Talas’ portfolio website, showcasing his user-interface-focused projects and front-end development work. The page includes information about Taner Talas, the programming languages and skills he has learned and uses, his services, projects with links, and contact information.",
      },
      nav: {
        menu: {
          home: "Home",
  ...
  const t = (lang, key) => key.split(".").reduce((o, k) => o?.[k], I18N[lang]);
